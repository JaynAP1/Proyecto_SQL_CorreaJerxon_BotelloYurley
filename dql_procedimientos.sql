...
-- 4. Calcular la la ganancia de un empleado semanal.
...
-- 5. Cambiar el sueldo diario de un empleado.
...
-- .6 Cambiar la cantidad de dias que trabaja un empleado.
...
-- 8. Actualizar una ruta existente.
...
-- 9. crear un proedimiento donde se agreguen nuevos clientes
...
-- 10 crear un proedimiento donde se agreguen nuevos proveedores 
...
-- 11  crear un procedimiento que agrege  nuevas empresas proveedoras de insumos agropecuarios
...
-- 12  crear un procedimiento que permita actualizar la cantidad de stock en inventario_productos según id.
...
-- 13  crear un procedimiento que permita agregar nuevas fincas si asi se desea
...
-- 14  crear un procedimiento que permita agregar nuevas maquinas.
...
-- 15  crear un procedimiento que cambie el estado de los productos entre los estados agotados o en venta
...
-- 16  crear un procedimiento que nos aplique un descuento del 5% a las ventas que tienen una cantidad de ventas  mayor a 40 y cuentan con trasportes
...
-- 17. Cambiar el estado de las maquinas.
...
-- 18. Cambiar el estado de un empleado.
...
begin
 ...
 Delimiter ;
call CambiarEstadoEmpleado(1,4);


-- 19 crear un procedimiento don se puedan eliminar empleados segun id 
...
call eliminar_empleado(45);
select * from empleado;

-- 20 crear procedimiento que permita eliminar los proveedores con los que se termino el convenio o se encuentran inactivo
